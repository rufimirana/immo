...
<style>.icon {
            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form method="POST" action="{{ route('login.custom') }}" class="login100-form validate-form">
                         @csrf
                        <span class="login100-form-title"> Membre de la CEM Login </span>
                        <?php if( isset($data['error_login']) ){ ?>
                            <div class="row" style="padding-bottom: 0.5em;">
                                <div class="col-md-12">
                                    <h5 style="color:red">{{$data['error_login']}}</h5>
                                </div>
                            </div>
                            <?php } ?>
  <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz" >
                        ...
                        <div class="container-login100-form-btn">
                            <button class="login100-form-btn">Accéder</button>
                        </div>

                        <div class="text-center p-t-12">
                            <span class="txt1">  </span>
                            <a class="txt2" href="#"> Mot de passe oublié? </a>
                        </div>
                    </form>
                </div>
            </div>
