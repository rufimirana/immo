...
!(function (a) {
    (a.color = {}),
        (a.color.make = function (t, i, e, o) {
            ...
            return (
                ...
                (n.normalize = function () {
                    ...
                    return (
                        (n.r = t(0, parseInt(n.r), 255)),
                        (n.g = t(0, parseInt(n.g), 255)),
                        (n.b = t(0, parseInt(n.b), 255)),
                        (n.a = t(0, n.a, 1)),
                        n
                    );
                }),
        ...
        (a.color.extract = function (t, i) {
            var e;
            do {
                if ("" != (e = t.css(i).toLowerCase()) && "transparent" != e)
                    break;
                t = t.parent();
            } while (t.length && !a.nodeName(t.get(0), "body"));
            return (
                "rgba(0, 0, 0, 0)" == e && (e = "transparent"), a.color.parse(e)
            );
        }),
    ...
    (function (q) {
        ...
        function Q(t, i) {
            ...
            if (
                null == e &&
                (((e = document.createElement("canvas")).className = t),
                q(e)
                    .css({
                        direction: "ltr",
                        position: "absolute",
        ...
        function o(x, t, i, o) {
                ...
                (C = (function (t) {
                    ...
                    (function () {
                        ...
                        for (
                            ...
                            ((n = C[t]).datapoints = { points: [] }),
                                I(W.processRawData, [n, n.data, n.datapoints]);
                        for (t = 0; t < C.length; ++t) {
                            if (
                                ((n = C[t]),
                                (h = n.data),
                                !(f = n.datapoints.format))
                            ) {
                                if (
                                    ((f = []).push({
                                        x: !0,
                                    ...
                                    n.bars.show ||
                                        (n.lines.show && n.lines.fill))
                                ) {
                                    var x = !!(
                                        (n.bars.show && n.bars.zero) ||
                                        (n.lines.show && n.lines.zero)
                                    );
                                    f.push({
                                        y: !0,
                                        number: !0,
                            ...
                            if (null == n.datapoints.pointsize) {
                                (n.datapoints.pointsize = f.length),
                                    (r = n.datapoints.pointsize),
                                    (a = n.datapoints.points);
                                var g = n.lines.show && n.lines.steps;
                                for (
                                    n.xaxis.used = n.yaxis.used = !0, i = e = 0;
                                    i < h.length;
                                    ++i, e += r
                                ) {
                                    var b = null == (c = h[i]);
                        ...
                        for (t = 0; t < C.length; ++t)
                            (n = C[t]),
                                I(W.processDatapoints, [n, n.datapoints]);
                        for (t = 0; t < C.length; ++t) {
                            (n = C[t]),
                                (a = n.datapoints.points),
                                (r = n.datapoints.pointsize),
                            ...
                            if (n.bars.show) {
                                ...
                                n.bars.horizontal
                                    ? ((k += M), (w += M + n.bars.barWidth))
                                    : ((v += M), (y += M + n.bars.barWidth));
                            }
            ...
            function f(t) {
                ...
                for (i = 0; i < p.length; ++i)
                    (e = p[i]) && e.used && (o["x" + e.n] = e.c2p(t.left));
                for (i = 0; i < m.length; ++i)
                    (e = m[i]) && e.used && (o["y" + e.n] = e.c2p(t.top));
                return (
                    ...
                    n
                        ? ((i += l),
                          "bottom" == o
                              ...
                              : ((e.box = { top: w.top + r, height: i }),
                                (w.top += i + r)))
                        : ((t += l),
                          "left" == o
                              ? ((e.box = { left: w.left + r, width: t }),
                                (w.left += t + r))
                              : ((w.right += t + r),
                                (e.box = {
            ...
            function l() {
                ...
                for (var o in (I(W.processOffset, [w]), w))
                    "object" == typeof S.grid.borderWidth
                        ? (w[o] += e ? S.grid.borderWidth[o] : 0)
                        : (w[o] += e ? S.grid.borderWidth : 0);
                if (
                        ...
                        q.each(a, function (t, i) {
                            ...
                            !(function (t) {
                                var i,
                                    e = t.options;
                                i =
                                    "number" == typeof e.ticks && 0 < e.ticks
                                        ? e.ticks
                                        : 0.3 *
                                          Math.sqrt(
                                              "x" == t.direction
                                ...
                                t.tickGenerator ||
                                    ...
                                    (t.tickFormatter = function (t, i) {
                                        var e = i.tickDecimals
                                                ? Math.pow(10, i.tickDecimals)
                                                : 1,
                                            o = "" + Math.round(t * e) / e;
                        ...
                        if (null == i)
                            for (t = i = 0; t < C.length; ++t)
                                i = Math.max(
                                    ...
                                    2 *
                                        (C[t].points.radius +
                                            C[t].points.lineWidth / 2)
                                );
                        var e = { left: i, right: i, top: i, bottom: i };
                        q.each(A(), function (t, i) {
                            i.reserveSpace &&
                                i.ticks &&
                                i.ticks.length &&
                            ...
                            (w.left = Math.ceil(Math.max(e.left, w.left))),
                            (w.right = Math.ceil(Math.max(e.right, w.right))),
                            (w.top = Math.ceil(Math.max(e.top, w.top))),
                            (w.bottom = Math.ceil(
                                Math.max(e.bottom, w.bottom)
                            ));
                    })(),
                        q.each(a, function (t, i) {
                            var e;
                            "x" == (e = i).direction
                                ? ((e.box.left = w.left - e.labelWidth / 2),
                                  (e.box.width =
                                      d.width -
                                      w.left -
                                      w.right +
                                      e.labelWidth))
                                : ((e.box.top = w.top - e.labelHeight / 2),
                                  (e.box.height =
                                      d.height -
                                      w.bottom -
                                      w.top +
                ...
                (M = d.width - w.left - w.right),
                    ...
                    q.each(i, function (t, i) {
                        !(function (t) {
                            ...
                            "x" == t.direction
                                ? ((e = t.scale =
                                      M / Math.abs(n(t.max) - n(t.min))),
                                  (o = Math.min(n(t.max), n(t.min))))
                                : ((e = -(e = t.scale =
                                      T / Math.abs(n(t.max) - n(t.min)))),
                        ...
                        q.each(A(), function (t, i) {
                            var e,
                                ...
                                h =
                                    ...
                                    "flot-tick-label tickLabel";
                            if (
                                (d.removeText(c), i.show && 0 != i.ticks.length)
                            )
                    ...
                    (function () {
                        ...
                        for (
                            ...
                            (t = C[r]).label &&
                                ...
                                o.push({ label: i, color: t.color });
                        if (S.legend.sorted)
                            if (q.isFunction(S.legend.sorted))
                                o.sort(S.legend.sorted);
                        ...
                        var c =
                            ...
                            e.join("") +
                            "</table>";
                        if (null != S.legend.container)
                            q(S.legend.container).html(c);
                        else {
                            var h = "",
                                f = S.legend.position,
                                u = S.legend.margin;
                                ...
                                "n" == f.charAt(0)
                                    ...
                                    : "s" == f.charAt(0) &&
                                      (h +=
                                          ...
                                          "px;"),
                                "e" == f.charAt(1)
                                    ? (h += "right:" + (u[0] + w.right) + "px;")
                                    : "w" == f.charAt(1) &&
                                      (h += "left:" + (u[0] + w.left) + "px;");
                            var d = q(
                                '<div class="legend">' +
                                    c.replace(
                                        'style="',
            ...
            function s() {
                ...
                t.show &&
                    ...
                    y.fillRect(0, 0, M, T),
                    y.restore()),
                    t.show && !t.aboveData && u();
                for (var i = 0; i < C.length; ++i)
                    I(W.drawSeries, [y, C[i]]), v(C[i]);
                        ...
                        if (
                            ...
                            if (!s || !c)
                                if (
                                    ...
                                    var h =
                                            a.lineWidth ||
                                            S.grid.markingsLineWidth,
                                        f = h % 2 ? 0.5 : 0;
                                    y.beginPath(),
                                        (y.strokeStyle =
                                            a.color || S.grid.markingsColor),
                                        (y.lineWidth = h),
                                        s
                                            ? (y.moveTo(r.to + f, l.from),
                                              y.lineTo(r.to + f, l.to))
                                            : (y.moveTo(r.from, l.to + f),
                                              y.lineTo(r.to, l.to + f)),
                                        y.stroke();
                                } else
                                    (y.fillStyle =
                                        a.color || S.grid.markingsColor),
                        ...
                        for (
                            y.lineWidth = 1,
                                ...
                                g.innermost ||
                                    ...
                                    y.lineTo(d + m, p + x),
                                    y.stroke()),
                                y.strokeStyle = g.options.tickColor,
                                y.beginPath(),
                                t = 0;
                            t < g.ticks.length;
                            ++t
                    ...
                    "object" == typeof e || "object" == typeof o
                        ? ("object" != typeof e &&
                          ...
                          0 < e.top &&
                              ...
                              (y.lineWidth = e.top),
                              y.beginPath(),
                              y.moveTo(0 - e.left, 0 - e.top / 2),
                              y.lineTo(M, 0 - e.top / 2),
                              y.stroke()),
                          0 < e.right &&
                              ((y.strokeStyle = o.right),
                              (y.lineWidth = e.right),
                              y.beginPath(),
                              y.moveTo(M + e.right / 2, 0 - e.top),
                              y.lineTo(M + e.right / 2, T),
                              y.stroke()),
                          0 < e.bottom &&
                              ((y.strokeStyle = o.bottom),
                              (y.lineWidth = e.bottom),
                              y.beginPath(),
                              y.moveTo(M + e.right, T + e.bottom / 2),
                              y.lineTo(0, T + e.bottom / 2),
                              y.stroke()),
                          0 < e.left &&
                              ((y.strokeStyle = o.left),
                              (y.lineWidth = e.left),
                              y.beginPath(),
                              y.moveTo(0 - e.left / 2, T + e.bottom),
                              y.lineTo(0 - e.left / 2, 0),
                              y.stroke()))
                        : ((y.lineWidth = e),
                          (y.strokeStyle = S.grid.borderColor),
                          y.strokeRect(-e / 2, -e / 2, M + e, T + e))),
                    y.restore();
            }
            function v(t) {
                t.lines.show &&
                        ...
                        function i(t, i, e, o, n) {
                            ...
                            for (var c = r; c < a.length; c += r) {
                                ...
                                if (null != h && null != u) {
                                    ...
                                    (h == l && f == s) ||
                                        y.moveTo(o.p2c(h) + i, n.p2c(f) + e),
                                        (l = u),
                                        (s = d),
                                        y.lineTo(o.p2c(u) + i, n.p2c(d) + e);
                                }
                            }
                            y.stroke();
                        }
                                ...
                                for (; !(0 < n && r > o.length + n); ) {
                                    ...
                                    if (null != f && null != d) {
                                        ...
                                        if (
                                            (l ||
                                                (y.beginPath(),
                                                y.moveTo(i.p2c(f), e.p2c(a)),
                                                (l = !0)),
                                            u >= e.max && p >= e.max)
                                        )
                                            y.lineTo(i.p2c(f), e.p2c(e.max)),
                                                y.lineTo(
                                                    i.p2c(d),
                                                    e.p2c(e.max)
                                                );
                                        else if (u <= e.min && p <= e.min)
                                            y.lineTo(i.p2c(f), e.p2c(e.min)),
                                                y.lineTo(
                                                    i.p2c(d),
                                                    e.p2c(e.min)
                                                );
                                            ...
                                            u <= p && u < e.min && p >= e.min
                                                ...
                                                y.lineTo(i.p2c(f), e.p2c(u)),
                                                y.lineTo(i.p2c(d), e.p2c(p)),
                                                d != x &&
                                                    (y.lineTo(
                                                        i.p2c(d),
                                                        e.p2c(p)
                    ...
                    t.bars.show &&
                        (function (c) {
                            ...
                            (function (t, i, e, o, n, a) {
                                for (
                                    var r = t.points, l = t.pointsize, s = 0;
                                    s < r.length;
                                    s += l
                                )
                                    null != r[s] &&
            ...
            (z.setData = n),
                ...
                (z.getAxes = function () {
                    var e = {};
                    return (
                        q.each(p.concat(m), function (t, i) {
                            i &&
                                (e[
                                    i.direction + (1 != i.n ? i.n : "") + "axis"
                                ] = i);
                        }),
                        e
                    );
                ...
                (z.highlight = B),
                (z.unhighlight = G),
                (z.triggerRedrawOverlay = j),
                (z.pointOffset = function (t) {
                    return {
                ...
                (z.hooks = W),
                (function () {
                    for (var t = { Canvas: Q }, i = 0; i < o.length; ++i) {
                        var e = o[i];
                ...
                (function (t) {
                    ...
                    null == S.xaxis.color &&
                        (S.xaxis.color = q.color
                            .parse(S.grid.color)
                            .scale("a", 0.22)
                            .toString());
                    null == S.yaxis.color &&
                        (S.yaxis.color = q.color
                            .parse(S.grid.color)
                            .scale("a", 0.22)
                            .toString());
                    ...
                    for (o = S.xaxes.length || 1, i = 0; i < o; ++i)
                        (e = S.xaxes[i]) &&
                            !e.tickColor &&
                            (e.tickColor = e.color),
                            (e = q.extend(!0, {}, S.xaxis, e)),
                            (S.xaxes[i] = e).font &&
                                ((e.font = q.extend({}, r, e.font)),
                                e.font.color || (e.font.color = e.color),
                                e.font.lineHeight ||
                                    (e.font.lineHeight = Math.round(
                                        1.15 * e.font.size
                                    )));
                    for (o = S.yaxes.length || 1, i = 0; i < o; ++i)
                        (e = S.yaxes[i]) &&
                            !e.tickColor &&
                            (e.tickColor = e.color),
                            (e = q.extend(!0, {}, S.yaxis, e)),
                            (S.yaxes[i] = e).font &&
                                ((e.font = q.extend({}, r, e.font)),
                                e.font.color || (e.font.color = e.color),
                                e.font.lineHeight ||
                    ...
                    null != S.shadowSize &&
                        (S.series.shadowSize = S.shadowSize);
                    null != S.highlightColor &&
                        (S.series.highlightColor = S.highlightColor);
                    for (i = 0; i < S.xaxes.length; ++i)
                        b(p, i + 1).options = S.xaxes[i];
                    for (i = 0; i < S.yaxes.length; ++i)
                        b(m, i + 1).options = S.yaxes[i];
                    for (var l in W)
                        S.hooks[l] &&
                            S.hooks[l].length &&
                            (W[l] = W[l].concat(S.hooks[l]));
                ...
                (function () {
                    x
                        ...
                        .remove(),
                        "static" == x.css("position") &&
                            x.css("position", "relative");
                    (d = new Q("flot-base", x)),
                        (e = new Q("flot-overlay", x)),
                        (y = d.context),
                        (c = e.context),
                        (h = q(e.element).unbind());
                    var t = x.data("plot");
                ...
                (function () {
                    S.grid.hoverable &&
                        (h.mousemove(L), h.bind("mouseleave", O));
            ...
            function H(t, i, e) {
                ...
                var l = (function (t, i, e) {
                    ...
                    return s
                        ? ((o = s[0]),
                          (n = s[1]),
                          (a = C[o].datapoints.pointsize),
                          {
                              datapoint: C[o].datapoints.points.slice(
                                  n * a,
                                  (n + 1) * a
                              ),
                              dataIndex: n,
                ...
                if (
                    (l &&
                        ...
                        (l.pageY = parseInt(
                            l.series.yaxis.p2c(l.datapoint[1]) + o.top + w.top,
                            10
                        ))),
            ...
            function j() {
                var t = S.interaction.redrawOverlayInterval;
                -1 != t ? D || (D = setTimeout(E, t)) : E();
            }
            function E() {
                var t, i;
                for (
            ...
            function B(t, i, e) {
                if (
                    ("number" == typeof t && (t = C[t]), "number" == typeof i)
                ) {
                ...
                var n = _(t, i);
                -1 == n
                    ? (N.push({ series: t, point: i, auto: e }), j())
                    : e || (N[n].auto = !1);
            }
            function G(t, i) {
                ...
                var e = i[0],
                    ...
                    r =
                        "string" == typeof t.highlightColor
                            ? t.highlightColor
                            : q.color.parse(t.color).scale("a", 0.5).toString();
                if (!(e < n.min || e > n.max || o < a.min || o > a.max)) {
                    ...
                    (e = n.p2c(e)),
                        ...
                        "circle" == t.points.symbol
                            ? c.arc(e, o, s, 0, 2 * Math.PI, !1)
                            : t.points.symbol(c, e, o, s, !1),
                        c.closePath(),
                        c.stroke();
                }
            }
            ...
            function Y(t, i, e, o) {
                ...
                for (
                    var n = y.createLinearGradient(0, e, 0, i),
                        a = 0,
                        r = t.colors.length;
                    a < r;
                    ++a
        ...
        q.fn.detach ||
            ...
            (Q.prototype.getTextInfo = function (t, i, e, o, n) {
                ...
                if (
                    ...
                    "object" == typeof e
                        ? c.css({ font: a, color: e.color })
                        : "string" == typeof e && c.addClass(e),
                        (s = l[i] =
                            {
            ...
            (Q.prototype.removeText = function (t, i, e, o, n, a) {
                if (null == o) {
                    ...
                    var u;
                    for (
                        h = this.getTextInfo(t, o, n, a).positions, f = 0;
                        (u = h[f]);
                        f++
                    )
                        u.x == i && u.y == e && (u.active = !1);
                }
            }),
