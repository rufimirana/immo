...
!(function (t, s) {
    "function" == typeof define && define.amd
        ...
        ? (module.exports = s(require("chartist")))
        : (t["Chartist.plugins.legend"] = s(t.Chartist));
})(this, function (n) {
    "use strict";
    var t = {
        className: "",
        ...
        (n.plugins.legend = function (u) {
            ...
            if (u && u.position) {
                if (
                    !(
                        "top" === u.position ||
                        "bottom" === u.position ||
                        u.position instanceof HTMLElement
                    )
                )
                    throw Error(
            ...
            return (
                ...
                function (l) {
                    ...
                    (o.className = "ct-legend"),
                        l instanceof n.Pie &&
                            o.classList.add("ct-legend-inside"),
                        "string" == typeof u.className &&
                            0 < u.className.length &&
                            o.classList.add(u.className),
                        l.options.width &&
                            (o.style.cssText =
                                "width: " +
                                l.options.width +
                    ...
                    i = u.legendNames || i;
                    var a =
                        Array.isArray(u.classNames) &&
                        u.classNames.length === i.length;
                    i.forEach(function (e, t) {
                        var s = document.createElement("li");
                        (s.className = "ct-series-" + t),
                            a && (s.className += " " + u.classNames[t]),
                            s.setAttribute("data-legend", t),
                            (s.textContent = e.name || e),
                            o.appendChild(s);
                    }),
                        l.on("created", function (e) {
                            if (u.position instanceof HTMLElement)
                                u.position.insertBefore(o, null);
                            else
                                switch (u.position) {
                                    case "top":
                                        l.container.insertBefore(
                                            o,
                                            l.container.childNodes[0]
                                        );
                                        break;
                                    case "bottom":
                        ...
                        u.clickable &&
                            o.addEventListener("click", function (e) {
                                ...
                                if (
                                    t.parentNode === o &&
                                    t.hasAttribute("data-legend")
                                ) {
                                    e.preventDefault();
                                    var s = parseInt(
                                            t.getAttribute("data-legend")
                                        ),
                                        i = r.indexOf(s);
                                    if (-1 < i)
                                        r.splice(i, 1),
                                        ...
                                        r.push(s), t.classList.add("inactive");
                                    else if (1 < l.data.series.length)
                                        r.push(s), t.classList.add("inactive");
                                    else
                                        (r = []),
