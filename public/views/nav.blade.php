 ...
 <li>
            ...
            <li class="menu-item-has-children dropdown">
              ...
              <ul class="sub-menu children dropdown-menu">
                <li>
                  <i></i
                  ><a href="">Taux d'amortissement par catégorie</a>
                </li>
                <li>
                  <i></i
                  ><a href="">Immobilisations amorties</a>
                </li>
              </ul>
            </li>
                        <li class="menu-item-has-children dropdown">
             ...
             <i></i>Inventaire</a
              ...
              <ul class="sub-menu children dropdown-menu">
                <li>
                  <i></i
                  ><a href="">Etablissement inventaire</a>
                </li>
                <li>
                  <i></i
                  ><a href="">Liste des immos disparues/perdues</a>
                </li>
              </ul>
            </li>
                        <li class="menu-item-has-children dropdown">
             ...
             <i></i>Cession des immobilisations</a
              ...
              <ul class="sub-menu children dropdown-menu ">
                <li>
                  <i></i><a href="">Céder une immobilisation</a>
                </li>
                <li>
                  <i></i
                  ><a href="">Immobilisations vendues</a>
                </li>
              </ul>
            </li>
